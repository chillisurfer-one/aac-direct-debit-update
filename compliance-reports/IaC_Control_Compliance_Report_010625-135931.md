...
**Analysis Date**: 2025-06-01 13:59:30
...
| security-module | INFRA-006-control | The security group configurations allow 0.0.0.0/0 for egress, which is a common tfsec check for high severity issues. The code does not explicitly show passing tfsec checks, but the configuration is relevant to the control. |

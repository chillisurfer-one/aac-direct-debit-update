...
**Analysis Date**: 2025-05-30 08:00:55
...
| rds-secrets-module | SEC-003-control | Non-Compliant❌ | Hardcoded secret found: db.password=admin123 | Ensure AWS Secrets Manager or environment injection is used for all secrets. |

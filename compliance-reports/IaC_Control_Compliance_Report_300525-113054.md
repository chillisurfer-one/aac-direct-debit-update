...
**Analysis Date**: 2025-05-30 11:30:53
...
| security-module | INFRA-006-control | Security group configurations allow 0.0.0.0/0 for egress, which is a common tfsec check for high severity issues. |
...
| observability-module | INFRA-005-control | Non-Compliant❌ | The aws_lambda_function resource 'audit-function' does not have CloudWatch logs enabled. | Ensure that CloudWatch logs are enabled for the 'audit-function' by setting 'cloudwatch_logs_enabled' to true. |

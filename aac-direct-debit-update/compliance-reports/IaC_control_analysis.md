...
**Analysis Date**: 2025-05-29 10:00:16
...
|  | INFRA-005-control | The aws_ecs_service resource is configured to use CloudWatch logs, as indicated by the presence of the 'cloudwatch_logs_enabled' attribute in the example JSON configuration. |
...
| security-module | INFRA-006-control | The security group configurations allow 0.0.0.0/0 for egress, which is a common tfsec check for high/critical issues. The code should be reviewed with tfsec to ensure compliance. |
